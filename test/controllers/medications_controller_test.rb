...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { md_description: @medication.md_description, md_name: @medication.md_name } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { md_description: @medication.md_description, md_name: @medication.md_name } }
