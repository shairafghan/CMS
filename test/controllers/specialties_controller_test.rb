...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { sp_description: @specialty.sp_description, sp_name: @specialty.sp_name } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { sp_description: @specialty.sp_description, sp_name: @specialty.sp_name } }
